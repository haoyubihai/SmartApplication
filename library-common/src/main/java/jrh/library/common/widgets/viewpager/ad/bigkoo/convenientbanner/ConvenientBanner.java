package jrh.library.common.widgets.viewpager.ad.bigkoo.convenientbanner;
...
import jrh.library.common.widgets.viewpager.ad.bigkoo.convenientbanner.adapter.CBPageAdapter;
import jrh.library.common.widgets.viewpager.ad.bigkoo.convenientbanner.helper.CBLoopScaleHelper;
import jrh.library.common.widgets.viewpager.ad.bigkoo.convenientbanner.holder.CBViewHolderCreator;
import jrh.library.common.widgets.viewpager.ad.bigkoo.convenientbanner.listener.CBPageChangeListener;
import jrh.library.common.widgets.viewpager.ad.bigkoo.convenientbanner.listener.OnItemClickListener;
import jrh.library.common.widgets.viewpager.ad.bigkoo.convenientbanner.listener.OnPageChangeListener;
import jrh.library.common.widgets.viewpager.ad.bigkoo.convenientbanner.view.CBLoopViewPager;
...
public class ConvenientBanner<T> extends RelativeLayout {
    ...
    public ConvenientBanner setPageIndicator(int[] page_indicatorId) {
        ...
        params.width = DensityUtil.dp2px(6);
        params.height = DensityUtil.dp2px(6);
        for (int count = 0; count < mDatas.size(); count++) {
            // 翻页指示的点
            ImageView pointView = new ImageView(getContext());
            params.rightMargin = DensityUtil.dp2px(8);
            pointView.setLayoutParams(params);
//            pointView.setPadding(DensityUtil.dp2px(4), 0, DensityUtil.dp2px(4), 0);

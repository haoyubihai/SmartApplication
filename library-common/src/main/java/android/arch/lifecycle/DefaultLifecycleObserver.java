...
/**
 * 由于FullLifecycleObserver为包可见，所以必须将该类放到android.arch.lifecycle包下
 * Callback interface for listening to {@link LifecycleOwner} state changes.
 */
@SuppressWarnings("unused")
public abstract class DefaultLifecycleObserver extends BaseObservable implements FullLifecycleObserver {
